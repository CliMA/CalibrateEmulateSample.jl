...
function mcmc_gp_test_step(prior:: ParameterDistribution, σ2_y, em::Emulator;
...
@testset "MarkovChainMonteCarlo" begin
    @testset "GP & rwm" begin
        ...
        mcmc_params = Dict(:mcmc_alg => "rwm", :obs_sample => 1.0, :param_init => 3.0, 
            :step => 0.5, :norm_factor=> nothing, :rng => rng)
        ...
        posterior_mean_2 = mcmc_gp_standardization_test_template(prior, σ2_y, em; 

...
echo "=== Submitting pushforward_from_posterior (L96 const-force, after ${EMU_JID}) ==="
...
echo "=== Submitting posterior_diagnostic_plots (L96 const-force, after ${PUSHFWD_JID}) ==="
...
echo "=== Submitting exp_to_leaderboard (L96 const-force, after ${PUSHFWD_JID}) ==="
...
# sbatch --parsable -A esm --job-name="pushfwd_l96_const" --export=ALL,EXPERIMENT=l96_const pushforward_from_posterior.sbatch

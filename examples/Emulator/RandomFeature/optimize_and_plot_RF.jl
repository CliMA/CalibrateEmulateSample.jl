...
if plot_flag
    ...
    figpath = joinpath(output_directory, "RF_test_observed_y1nonoise.png")
    savefig(figpath)
    ...
    figpath = joinpath(output_directory, "RF_test_observed_y2nonoise.png")
    savefig(figpath)
    ...
    figpath = joinpath(output_directory, "RF_test_observed_y1.png")
    savefig(figpath)
    ...
    figpath = joinpath(output_directory, "RF_test_observed_y2.png")
    savefig(figpath)

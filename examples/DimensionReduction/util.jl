...
function do_mcmc(callback, dim, logpost, num_chains, num_samples_per_chain, mcmc_sampler, prior_cov, initial_guess; subsample_rate=1)
    ...
    for batch in 1:num_batches
        ...
        chain = sample(density_model, sampler, MCMCThreads(), num_samples_per_chain, num_chains_in_batch; chain_type=Chains, initial_params=[initial_guess for _ in 1:num_chains_in_batch])
